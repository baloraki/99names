  ...
  return (
    <>
      ...
      <section
        ref={cardRef}
        key={name.id}
        className="relative touch-pan-y select-none rounded-lg border border-gold/20 bg-[radial-gradient(circle_at_top,rgba(214,178,94,0.18),rgba(30,39,66,0.94)_62%)] p-6"
        style={{
          opacity: fading ? 0 : 1,
